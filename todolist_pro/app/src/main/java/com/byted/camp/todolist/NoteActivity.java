...
public class NoteActivity extends AppCompatActivity {
    ...
    private RadioGroup priorityRag;
    private RadioButton priRb1;
    private RadioButton priRb2;
    private RadioButton priRb3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        priRb1 = findViewById(R.id.radioButton);
        priRb2 = findViewById(R.id.radioButton2);
        priRb3 = findViewById(R.id.radioButton3);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(priRb1.isChecked())
                    priority = 2;
                else if(priRb2.isChecked())
                    priority = 1;
                else if(priRb3.isChecked())
                    priority = 0;
